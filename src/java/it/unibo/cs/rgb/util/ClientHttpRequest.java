...
public class ClientHttpRequest {
    ...
    public void setParameter(String name, String filename, InputStream is, String contentType) throws IOException {
        boundary();
        writeName(name);
        write("; filename=\"");
        write(filename);
    ...
    public void setParameter(String name, File file) throws IOException {
        setParameter(name, file.getPath(), new FileInputStream(file), null);
    }
    ...
    public InputStream post() throws IOException {
        ...
        try {
            ...
            //return connection.getInputStream(); //TODO risolvere, è da ignorare il codice di errore e prendere l'input stream dell'errore
